        ...
        <div class="contain-header">
            <div class="conteudo">
                ...
                <ul>
                        <li><a>Início</a></li>
                        <li><a>Contato</a></li>
                        <li><a style="cursor: pointer !important;" onclick="busca('cadernos')">Cadernos</a></li>
                        ...
                        if($query->num_rows > 0) {
                            while($row = $query->fetch_assoc()){
                                ...
                                if($desconto <= 1){
                                    ...
                                    $preco_com_desconto = (float)number_format((float)$preco - (float)$preco*$desc, 2);
                                }
                            }
                        }else{
                ...
                <div class="price-wrapper">
                    ...
                    <div class="price-container">
                        ...
                        <div class="price-details">
                            <span class="current-price">R$ <?php print number_format($preco-($preco*$desc), 2); ?> 
                                <span class="discount"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-arrow-down-short" viewBox="0 0 16 16">
                                    <path fill-rule="evenodd" d="M8 4a.5.5 0 0 1 .5.5v5.793l2.146-2.147a.5.5 0 0 1 .708.708l-3 3a.5.5 0 0 1-.708 0l-3-3a.5.5 0 1 1 .708-.708L7.5 10.293V4.5A.5.5 0 0 1 8 4"/>
                                </svg> 11%</span></span>
                        </div>
                        <div class="buttons">
                            <span class="installments">Em até 12x de R$ <?php print number_format(($preco-($preco*$desc))/12, 2); ?></span>
                            <div class="smaller-button">R$ <?php print number_format($preco - ($preco-($preco*$desc)), 2); ?> de desconto</div>
...
<?php
                    ...
                    ?>
                    <h1 style="color:rgb(31, 197, 31)">Escolha um produto para entrar na tela</h1>
