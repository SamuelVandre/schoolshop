...
<body class="text-center">
    <main class="form-signin">
        ...
        <form action="#" method="post" enctype="multipart/form-data">
            ...
            <div class="form-floating p-2">
                <input type="number" min="1" name="qtd" class="form-control" id="floatingPassword"
                    placeholder="Password">
                <label for="floatingPassword">Quantidade do Produto</label>
            </div>
            <div class="form-floating p-2">
                <input type="number" step="0.01" name="valor" class="form-control" id="floatingPassword"
                    placeholder="Password">
            ...
            <div class="form-floating p-2 mb-3">
                <input type="number" step="0.01" name="desconto" class="form-control" id="floatingPassword"
                    placeholder="Password">
                <label for="floatingPassword">Desconto do Produto (em %)</label>
            </div>
    ...
    if (count($_POST) > 0) {
        if ($_SESSION['usuario'] === 'admin') {
            ...
            if ($testExiste->num_rows > 0) {
                ...
                if ($_SERVER["REQUEST_METHOD"] == "POST") {
                    ...
                    if ($_FILES["imagem0"]["error"] == UPLOAD_ERR_OK) {
                        ...
                        if (
                            move_uploaded_file($_FILES["imagem0"]["tmp_name"], $destino[0])
            ...
            print "<script>alert('Você precisa se logar como administrador para poder cadastrar os produtos')</script>";
        }
    }
    ?>
